  ...
  <div class="sm:flex">
    ...
    <div class="relative lg:w-[580px] md:w-96 w-full p-10 min-h-screen bg-white shadow-xl flex items-center pt-10 dark:bg-slate-900 z-10">
      ...
      <div class="w-full lg:max-w-sm mx-auto space-y-10" uk-scrollspy="target: > *; cls: uk-animation-scale-up; delay: 100 ;repeat: true">
        ...
        <!-- form -->
        <form   space-y-7 text-sm text-black font-medium dark:text-white"  uk-scrollspy="target: > *; cls: uk-animation-scale-up; delay: 100 ;repeat: true"  method="POST" action="include/reg.inc.php">
          ...
          <div class="grid grid-cols-2 gap-4 gap-y-7">
            ...
            <div>
                ...
                <div class="mt-2.5">
                    <input id="text" name="first_name" type="text"  autofocus="" placeholder="First name" required="" class="!w-full !rounded-lg !bg-transparent !shadow-sm !border-slate-200 dark:!border-slate-800 dark:!bg-white/5"> 
                </div>
            </div>
            ...
            <div>
                ...
                <div class="mt-2.5">
                    <input id="text" name="last_name" type="text" placeholder="Last name" required="" class="!w-full !rounded-lg !bg-transparent !shadow-sm !border-slate-200 dark:!border-slate-800 dark:!bg-white/5"> 
                </div>
            </div>
            ...
            <div>
              ...
              <div class="mt-2.5">
                  <input id="password" name="password_hash" type="password" placeholder="***"  class="!w-full !rounded-lg !bg-transparent !shadow-sm !border-slate-200 dark:!border-slate-800 dark:!bg-white/5">  
              </div>
            </div>
            ...
            <div>
                ...
                <div class="mt-2.5">
                    <input id="password" name="pwd-repeart" type="password" placeholder="***"  class="!w-full !rounded-lg !bg-transparent !shadow-sm !border-slate-200 dark:!border-slate-800 dark:!bg-white/5">  
                </div>
            </div>
            ...
            <!-- submit button -->
            <div class="col-span-2">
              <button type="submit" name="signup-submit" class="button bg-primary text-white w-full">Get Started</button>
            </div>
