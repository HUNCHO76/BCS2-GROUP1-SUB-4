            ...
            <div class="w-full lg:max-w-sm mx-auto space-y-10"
                ...
                <div>
                    ...
                    <p class="text-sm text-gray-700 font-normal">If you haven’t signed up yet. <a
                            href="form-register.php" class="text-blue-700">Register here!</a></p>
                </div>


                <!-- form -->
                <form method="POST" action="include/login.inc.php" space-y-7 text-sm text-black font-medium
                    dark:text-white" uk-scrollspy="target: > *; cls: uk-animation-scale-up; delay: 100 ;repeat: true">
                    ...
                    <div>
                        ...
                        <div class="mt-2.5">
                            <input id="pwd" name="password_hash" type="password" placeholder="***"
                                class="!w-full !rounded-lg !bg-transparent !shadow-sm !border-slate-200 dark:!border-slate-800 dark:!bg-white/5">
                        </div>
                    </div>
                    ...
                    <div>
                        <button type="submit" name="login-submit" class="button bg-primary text-white w-full">Sign
                            in</button>
                    </div>
